...
const seats: Seat[] = Array.from({ length: 72 }, (_, i) => {
  ...
  return { id: `${row}-${number}`, row, number, category: row < 'C' ? 'Premium' : 'Standard', status: [3, 4, 14, 15, 26, 38, 39, 51, 64, 65].includes(i) ? 'sold' : 'available', price: row < 'C' ? 3000 : 2500 };
});
